...
<div>
  <el-container>
    ...
    <el-container>
      ...
      <el-container>
        <el-main>
          <el-row :gutter="40" v-show="showSongs" style="height:560px">
            <!-- 图像分类的标签显示 -->
            <el-col :span="3" style="background-color: #b3c0d1">
              <!-- 标签展示 -->
              <ul>
                <!-- 过度动画 -->
                <transition-group
                ...
                >
                  <li v-show="showTags" v-for="(item, index) in tags" :key="index">
                    <el-tag type="success" effect="dark" style="width: 80px">
                      {{item}}
                    </el-tag>
                  </li>
                </transition-group>
            ...
            <!-- 推荐歌曲列表显示 -->
            <el-col :span="16" style="background-color:#CCAE33 ">
            ...
            <!-- 用户自己对图像进行标签选择 -->
            <el-col
              class="all_selected_tags"
              :span="5"
              style="background-color: #d3dce6; height:540px"
            >
            <h2 v-show="showSongs" style="line-height:80px">你的感觉</h2>
              <el-row v-show="showSongs" type="flex">
                <el-col
                  :span="14"
             ...
             <el-row v-show="showSongs" type="flex" style="line-height:60px">
            <el-button type="primary" round style="text-align: center;">确认标签</el-button>
             </el-row>
            </el-col>
          </el-row>
        </el-main>
...
export default {
  ...
  methods: {
    ...
    uploadImage(){
      ...
      axios.post("http://localhost:8081//book/imageClassification", formData).then(res =>{
